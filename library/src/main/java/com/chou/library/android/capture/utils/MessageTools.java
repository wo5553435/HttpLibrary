package com.chou.library.android.capture.utils;
...
public class MessageTools {
	...
	public MessageTools(WebView webView,Builder builder){
...
//					WindowManager.LayoutParams.TYPE_APPLICATION);
	 ...
	 */
	public static void showOnClickDialog (final DialogInterface.OnClickListener negativeListener,
			final DialogInterface.OnClickListener positiveListener,final String msg,final Context c) {
